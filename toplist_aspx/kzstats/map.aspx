<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="map.aspx.cs" Inherits="kzstats.map" %>
...
<body runat="server" id = "gcBody" bgcolor="#637385" background="img/bg3.png">
    ...
    <div style="text-align: center">
        ...
        <asp:Panel ID="Panel3" runat="server" BackColor="#F3F1EA" BorderStyle="Solid" 
            ...
            <br />
            <asp:Label ID="gcLabelMapName" runat="server" Font-Bold="True" Font-Names="Arial" 
