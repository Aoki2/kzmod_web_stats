<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="playerranks.aspx.cs" Inherits="kzstats.playerlist" %>
...
<body runat="server" id = "gcBody" bgcolor="#637385" background="img/bg3.png">
    ...
    <div style="text-align: center">
        ...
        <asp:Panel ID="Panel3" runat="server" BackColor="#EEEBDC" BorderStyle="Solid" 
            ...
            Font-Names="Verdana" BorderColor="#637385" 
            BackImageUrl="~/img/panel_bg2.png">
            <br />
            <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Names="Arial" 
                Font-Size="X-Large" ForeColor="#5D6E75" Text="Player Rankings"></asp:Label>
            <br />
